...
export const INIT_DATA = {
    ...
    path_nodes: [
        ...
        { id: "f0_combos", course_id: "course_vi_en_v1", unit_id: "phase_0_foundations", node_index: 5, node_type: "skill", module_type: "orange", label: "Combining vowels", practice_route: "/practice/vowels-diph-1", sessions_required: 1, difficulty: 2, cefr_level: "A1.1", vocab_introduces: [], vocab_requires: [] },
        { id: "f0_combos2", course_id: "course_vi_en_v1", unit_id: "phase_0_foundations", node_index: 6, node_type: "skill", module_type: "orange", label: "Gliding vowels", practice_route: "/practice/vowels-diph-2", sessions_required: 1, difficulty: 2, cefr_level: "A1.1", vocab_introduces: [], vocab_requires: [] },
        { id: "f0_combos3", course_id: "course_vi_en_v1", unit_id: "phase_0_foundations", node_index: 7, node_type: "skill", module_type: "orange", label: "Advanced sounds", practice_route: "/practice/vowels-diph-3", sessions_required: 1, difficulty: 2, cefr_level: "A1.1", vocab_introduces: [], vocab_requires: [] },
        { id: "f0_t1", course_id: "course_vi_en_v1", unit_id: "phase_0_foundations", node_index: 8, node_type: "skill", module_type: "orange", label: "Tones: Level vs Falling", practice_route: "/practice/tones/level1", sessions_required: 1, difficulty: 1, cefr_level: "A1.1", vocab_introduces: [], vocab_requires: [] },
        { id: "f0_t2", course_id: "course_vi_en_v1", unit_id: "phase_0_foundations", node_index: 9, node_type: "skill", module_type: "orange", label: "Tones: add Rising", practice_route: "/practice/tones/level2", sessions_required: 1, difficulty: 1, cefr_level: "A1.1", vocab_introduces: [], vocab_requires: [] },
        { id: "f0_t3", course_id: "course_vi_en_v1", unit_id: "phase_0_foundations", node_index: 10, node_type: "skill", module_type: "orange", label: "Tones: add Dipping", practice_route: "/practice/tones/level3", sessions_required: 1, difficulty: 1, cefr_level: "A1.1", vocab_introduces: [], vocab_requires: [] },
        { id: "f0_t4", course_id: "course_vi_en_v1", unit_id: "phase_0_foundations", node_index: 11, node_type: "skill", module_type: "orange", label: "Hỏi vs Ngã", practice_route: "/practice/tones/level4", sessions_required: 1, difficulty: 2, cefr_level: "A1.1", vocab_introduces: [], vocab_requires: [] },
        { id: "f0_t5", course_id: "course_vi_en_v1", unit_id: "phase_0_foundations", node_index: 12, node_type: "skill", module_type: "orange", label: "All 6 tones", practice_route: "/practice/tones/level5", sessions_required: 1, difficulty: 2, cefr_level: "A1.1", vocab_introduces: [], vocab_requires: [] },
        { id: "f0_marks", course_id: "course_vi_en_v1", unit_id: "phase_0_foundations", node_index: 13, node_type: "skill", module_type: "orange", label: "Read the tone marks", practice_route: "/practice/tonemarks-basic", sessions_required: 1, difficulty: 1, cefr_level: "A1.1", vocab_introduces: [], vocab_requires: [] },
