...
function createInitialData({ full = false } = {}) {
    ...
    path_nodes: [
        ...
        // Units 4–6 (rest of A1 / Phase 1) — same 4-module structure.
        { id: "p4_PRON", course_id: "course_vi_en_v1", unit_id: "phase_4_food", node_index: -1, node_type: "skill", module_type: "blue", label: "Pronunciation: Tone marks", practice_route: "/practice/tonemarks-basic", difficulty: 1, cefr_level: "A1.2", vocab_introduces: [], vocab_requires: [] },
        { id: "p4_GRAM", course_id: "course_vi_en_v1", unit_id: "phase_4_food", node_index: 8.5, node_type: "skill", module_type: "purple", label: "Grammar: Counters (cái, con…)", skill_content: { type: "grammar_unit", grammar_unit_id: "A1_M14_U01" }, difficulty: 2, cefr_level: "A1.2", vocab_introduces: [], vocab_requires: [] },
        { id: "p5_PRON", course_id: "course_vi_en_v1", unit_id: "phase_5_market", node_index: -1, node_type: "skill", module_type: "blue", label: "Pronunciation: Vowel combos", practice_route: "/practice/vowels-diph-1", difficulty: 1, cefr_level: "A1.3", vocab_introduces: [], vocab_requires: [] },
        { id: "p5_GRAM", course_id: "course_vi_en_v1", unit_id: "phase_5_market", node_index: 10.5, node_type: "skill", module_type: "purple", label: "Grammar: Saying 'very' (rất/quá)", skill_content: { type: "grammar_unit", grammar_unit_id: "A1_M26_U01" }, difficulty: 2, cefr_level: "A1.3", vocab_introduces: [], vocab_requires: [] },
        { id: "p6_PRON", course_id: "course_vi_en_v1", unit_id: "phase_6_numbers", node_index: -1, node_type: "skill", module_type: "blue", label: "Pronunciation: Final consonants", practice_route: "/practice/consonants-final", difficulty: 1, cefr_level: "A1.3", vocab_introduces: [], vocab_requires: [] },
        { id: "p6_GRAM", course_id: "course_vi_en_v1", unit_id: "phase_6_numbers", node_index: 12.5, node_type: "skill", module_type: "purple", label: "Grammar: Numbers", skill_content: { type: "grammar_unit", grammar_unit_id: "A1_M13_U01" }, difficulty: 2, cefr_level: "A1.3", vocab_introduces: [], vocab_requires: [] },
        ...
        { id: "p3_SC1", course_id: "course_vi_en_v1", unit_id: "phase_3_cafe", node_index: 10, topic: "restaurant", node_type: "scene", module_type: "green", label: "☕ At the Café", scene_id: "scene_cafe_001", difficulty: 7, cefr_level: "A1.2", vocab_introduces: [], vocab_requires: [] },
        ...
        { id: "p4_SC1", course_id: "course_vi_en_v1", unit_id: "phase_4_food", node_index: 10, topic: "restaurant", node_type: "scene", module_type: "green", label: "🛵 Street Food Stall", scene_id: "scene_streetfood_001", difficulty: 7, cefr_level: "A1.2", vocab_introduces: [], vocab_requires: [] },
        ...
        { id: "p5_SC1", course_id: "course_vi_en_v1", unit_id: "phase_5_market", node_index: 12, topic: "shopping", node_type: "scene", module_type: "green", label: "🛒 At the Market", scene_id: "scene_market_001", difficulty: 7, cefr_level: "A1.3", vocab_introduces: [], vocab_requires: [] },
        ...
        { id: "p6_SC1", course_id: "course_vi_en_v1", unit_id: "phase_6_numbers", node_index: 14, topic: "restaurant", node_type: "scene", module_type: "green", label: "🍜 At the Restaurant", scene_id: "scene_restaurant_001", difficulty: 8, cefr_level: "A1.3", vocab_introduces: [], vocab_requires: [] },
        ...
        { id: "p7_SC1", course_id: "course_vi_en_v1", unit_id: "phase_7_transport", node_index: 18, topic: "transport", node_type: "scene", module_type: "green", label: "🚕 Getting a Taxi", scene_id: "scene_taxi_001", difficulty: 8, cefr_level: "A2.1", vocab_introduces: [], vocab_requires: [] },
        { id: "p7_SC2", course_id: "course_vi_en_v1", unit_id: "phase_7_transport", node_index: 19, topic: "airport", node_type: "scene", module_type: "green", label: "✈️ At the Airport", scene_id: "scene_airport_001", difficulty: 8, cefr_level: "A2.1", vocab_introduces: [], vocab_requires: [] },
        ...
        { id: "p8_SC1", course_id: "course_vi_en_v1", unit_id: "phase_8_daily", node_index: 22, topic: "hotel", node_type: "scene", module_type: "green", label: "🏨 Checking into a Hotel", scene_id: "scene_hotel_001", difficulty: 9, cefr_level: "A2.1", vocab_introduces: [], vocab_requires: [] },
