...
const INIT_DATA = {
    ...
    path_nodes: [
        ...
        { id: "p3_G1", course_id: "course_vi_en_v1", unit_id: "phase_3_cafe", node_index: 6, node_type: "skill", module_type: "purple", label: "Grammar: Want to (muốn)", skill_content: { type: "grammar_unit", grammar_unit_id: "A1_M25_U01" }, difficulty: 4, cefr_level: "A1.2", vocab_introduces: [], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p3_Q006" }] } },
        ...
        { id: "p4_G1", course_id: "course_vi_en_v1", unit_id: "phase_4_food", node_index: 3, node_type: "skill", module_type: "purple", label: "Grammar: Counters (cái)", skill_content: { type: "grammar_unit", grammar_unit_id: "A1_M14_U01" }, difficulty: 4, cefr_level: "A1.2", vocab_introduces: [], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p4_Q007" }] } },
        ...
        { id: "p5_S2", course_id: "course_vi_en_v1", unit_id: "phase_5_market", node_index: 8, node_type: "skill", module_type: "purple", label: "Grammar: Adjectives", skill_content: { type: "grammar_unit", grammar_unit_id: "A1_M09_U01" }, difficulty: 4, cefr_level: "A1.3", vocab_introduces: [], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p5_Q010" }] } },
        { id: "p5_G1", course_id: "course_vi_en_v1", unit_id: "phase_5_market", node_index: 9, node_type: "skill", module_type: "purple", label: "Grammar: Very (rất)", skill_content: { type: "grammar_unit", grammar_unit_id: "A1_M26_U01" }, difficulty: 4, cefr_level: "A1.3", vocab_introduces: [], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p5_S2" }] } },
        ...
        { id: "p8_G1", course_id: "course_vi_en_v1", unit_id: "phase_8_daily", node_index: 9, node_type: "skill", module_type: "purple", label: "Grammar: Present Tense", skill_content: { type: "grammar_unit", grammar_unit_id: "A1_M02_U01" }, difficulty: 6, cefr_level: "A2.1", vocab_introduces: [], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p8_S2" }] } },
        ...
        { id: "p9_S3", course_id: "course_vi_en_v1", unit_id: "phase_9_social", node_index: 9, node_type: "skill", module_type: "purple", label: "Grammar: Should & Shouldn't", skill_content: { type: "grammar_unit", grammar_unit_id: "A1_M20_U01" }, difficulty: 7, cefr_level: "A2.2", vocab_introduces: [], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p9_Q023" }] } },
        { id: "p9_G1", course_id: "course_vi_en_v1", unit_id: "phase_9_social", node_index: 10, node_type: "skill", module_type: "purple", label: "Grammar: Because (vì)", skill_content: { type: "grammar_unit", grammar_unit_id: "A1_M17_U01" }, difficulty: 7, cefr_level: "A2.2", vocab_introduces: [], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p9_S3" }] } },
