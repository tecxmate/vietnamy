                    ...
                    <>
                        {inAppBrowser ? (
                            <div style={{ textAlign: 'center', padding: '16px', backgroundColor: 'var(--surface-color-light)', borderRadius: 12 }}>
                                <p style={{ fontSize: 16, fontWeight: 600, marginBottom: 8 }}>Open in your browser</p>
                                <p style={{ fontSize: 14, color: 'var(--text-muted)', marginBottom: 12 }}>
                                    Google sign-in doesn't work in this browser. Tap the menu (⋯) and select "Open in Safari" or "Open in Browser".
                                </p>
                                <button
