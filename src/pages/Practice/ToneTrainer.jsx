...
// so the user sees what they're discriminating against.
const MINIMAL_PAIRS = [
    { base: 'ma', set: [
...
function pickRounds(n) {
    ...
    for (let i = 0; i < n; i++) {
        ...
        const target = cluster.set[Math.floor(Math.random() * cluster.set.length)];
