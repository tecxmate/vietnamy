...
| 3.4 | Adopt PracticeKit across all practice screens (~4 of ~47 today). Remaining edge cases: **ToneMarks** (multi-stage + pitch cards), **Numbers** (builder), **Kinship/Pronouns**, **Telex/TeenCode** (typing, not tiles). | TODO |
